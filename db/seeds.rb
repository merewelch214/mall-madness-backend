...
user21 = User.create(username: 'bill', password: '123', role: 'owner')
user22 = User.create(username: 'test', password: '123', role: 'owner')
user23 = User.create(username: 'tester', password: '123', role: 'owner')
...
cinnabon = Store.create(user: user21, name: 'Cinnabon', category: 'Food')
auntieAnns = Store.create(user: user22, name: 'Auntie Annes', category: 'Food')
sharperImage = Store.create(user: user23, name: 'Sharper Image', category: 'Gadgets')
